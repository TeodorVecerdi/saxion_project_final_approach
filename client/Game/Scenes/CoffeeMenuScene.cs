...
namespace game {
    public class CoffeeMenuScene : Scene {
        ...
        public override void Load() {
            ...
            backgroundImage1 = new Image(0, 0, Globals.WIDTH, Globals.HEIGHT, new game.Sprite("data/sprites/locations/coffee_fellows/menu_1.jpg", true, false)) {x = 0f};
            backgroundImage2 = new Image(0, 0, Globals.WIDTH, Globals.HEIGHT, new game.Sprite("data/sprites/locations/coffee_fellows/menu_2.jpg", true, false)) {x = -100000f};
            backgroundImage3 = new Image(0, 0, Globals.WIDTH, Globals.HEIGHT, new game.Sprite("data/sprites/locations/coffee_fellows/menu_3.jpg", true, false)) {x = -100000f};
