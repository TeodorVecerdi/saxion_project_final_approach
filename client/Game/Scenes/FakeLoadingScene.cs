...
namespace game {
    public class FakeLoadingScene : Scene {
        ...
        public override void Load() {
            ...
            Root.AddChild(extra2 = new Label(0, Globals.HEIGHT/2f + 250, Globals.WIDTH, 100, "Go grab a beer, get comfortable and get ready to have some fun!", LabelStyle.Default.Alter(textAlignmentNormal:FontLoader.CenterCenterAlignment, textSizeNormal:32f, fontLoaderInstance:FontLoader.SourceCodeBold)) {x = -100000f});
            IsLoaded = true;
        }
