namespace GXPEngine {
    ...
    public class MouseHandler {
        ...
        private bool _wasMouseDown; //was the mouse down last time we checked?
        private bool _wasMouseDownOnTarget; //was the mouse down on the target last time we checked?

        //internal administration variables
        private bool _wasOnTarget; //was the mouse on target last frame?
        ...
        private void HandleOnStep() {
            ...
            var isOnTarget = _target.HitTestPoint(Input.mouseX, Input.mouseY);
